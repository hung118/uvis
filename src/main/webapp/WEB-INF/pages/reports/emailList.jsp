...
<title>VIS <s:text name="report.emailList" /></title>	
...
<body>
	...
	<h1><s:text name="report.emailList" /></h1>
	<p>List veterans who have email addresses with preferable contact-by email excluding deceases.</p>
	<s:actionerror/>
	<s:form action="generateEmailListReport">
		<table width="450" border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
				<td width="30%"><font color=red>*</font>From Last Update:</td>
				<td width="70%"> 
			...
			<tr>
				<td><font color=red>*</font>To Last Update: </td>
				<td> 
