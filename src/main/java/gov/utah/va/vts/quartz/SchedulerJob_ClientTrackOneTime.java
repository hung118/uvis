 ...
 * import for ClientTrack records on new database schema; after that, two lines in Scheduler section
 ...
 * 
 */
public class SchedulerJob_ClientTrackOneTime extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext jobExecutioncontext)
		...
		try {
			...
			// run tasks
			schedulerTask.runClientTrackImport(em);	
